...
console.log(
  `Socket Server is running in ${isProduction ? 'production' : 'development'} mode!`
);

const socketUsers = new Map();

// Socket.IO event handlers and utility functions
...
const port = isProduction ? 443 : process.env.SOCKET_PORT || 3030;
server.listen(port, () => {
